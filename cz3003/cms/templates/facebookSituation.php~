...
<script type="text/javascript"> 
   a = a + "Earthquake magnitude: " + "{{sensor.value}} " + "\n";
</script>
{% endif%}	
{%endfor%}
{% for sensor in sensorList %}
