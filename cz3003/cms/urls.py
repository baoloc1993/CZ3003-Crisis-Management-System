...
urlpatterns = patterns('',
		...
		url(r'^fbStatus', views.facebook, name='fbStatus'),
		url(r'^fbPost', views.facebookSelect, name='fbPost'),
		url(r'^fbBegin', views.facebookBegin, name='fbBegin'),
		url(r'^fbSituation', views.facebookSituation, name='fbSituation'),
		url(r'^fbEnd', views.facebookEnd, name='fbEnd'),
